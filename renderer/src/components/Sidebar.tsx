...
export default function Sidebar({ activeView, onNavigate, onToggleTaskPanel }: Props) {
  ...
  const shortWorkspace = workspace ? (workspace.split(/[\\/]/).pop() ?? workspace) : 'No workspace';
    ...
    <div className="sidebar">
      ...
      <div className="sidebar-logo">
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
          ...
          <path
            d="M14 5L20 9.5V18.5L14 23L8 18.5V9.5L14 5Z"
            stroke="url(#og-grad)"
            strokeWidth="1.8"
            fill="none"
          />
      ...
      <div className="sidebar-footer">
        ...
        <div
          ...
          title={workspace ?? 'Click to open workspace'}
        >
          <span>📁</span>
          <span
            style={{ flex: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}
